...
const FeaturedPosts = () => {
  ...
  const customLeftArrow = (
    <div className='absolute arrow-btn left-0 text-center p-3 cursor-pointer bg-white rounded-full'>
      <svg
  ...
  const customRightArrow = (
    <div className='absolute arrow-btn right-0 text-center p-3 cursor-pointer bg-white rounded-full'>
      <svg
        xmlns='http://www.w3.org/2000/svg'
        className='h-6 text-indigo '
        fill='none'
